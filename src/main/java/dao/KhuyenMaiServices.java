...
public interface KhuyenMaiServices extends Remote{
	ArrayList<KhuyenMai> getAllKhuyenMais() throws RemoteException;
	KhuyenMai getKhuyenMaiTheoMaKhuyenMai(String maKhuyenMai) throws RemoteException;
	ArrayList<KhuyenMai> getKhuyenMaiTheoTenKhuyenMai(String tenKhuyenMai) throws RemoteException;
	KhuyenMai getKhuyenMaiTheoNgayBatDauKM(String ngayBatDau) throws RemoteException;
	float getPhanTramKhuyenMaiTheoMaKM(String maKM) throws RemoteException;
	boolean addKhuyenMai(KhuyenMai km) throws RemoteException;
	boolean updateKhuyenMai(KhuyenMai km) throws RemoteException;
