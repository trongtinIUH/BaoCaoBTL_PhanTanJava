...
public interface HoaDonDatPhongServices extends Remote{
	ArrayList<HoaDonDatPhong> getAllHoaDonDatPhong() throws RemoteException;
	HoaDonDatPhong getHoaDonTheoMaHoaDon(String maHD) throws RemoteException;
	String getMaHDTheoMaPhieuDP(String maPhieuDP) throws RemoteException;
	HoaDonDatPhong getHoaDonDatPhongTheoMaHD(String maHD) throws RemoteException;
	HoaDonDatPhong getHoaDonDatPhongTheoMaPDP(String maPDP) throws RemoteException;
	ArrayList<HoaDonDatPhong> getHoaDonDatPhongTheoTenKH(String tenKH) throws RemoteException;
	ArrayList<HoaDonDatPhong> getHoaDonDatPhongTheoMaNV(String maNV) throws RemoteException;
	ArrayList<HoaDonDatPhong> getHoaDonTheoNgayLapHD(String ngayLapHD) throws RemoteException;
	ArrayList<HoaDonDatPhong> getHoaDonTheoThang(String thang, int nam) throws RemoteException;
	ArrayList<HoaDonDatPhong> getHoaDonTheoNam(int nam) throws RemoteException;
	boolean updateHoaDon(String maHD, Date ngayLap, Boolean status, String maNV) throws RemoteException;
	boolean updateHoaDon2(HoaDonDatPhong hd) throws RemoteException;
	boolean updateHoaDon3(HoaDonDatPhong hd) throws RemoteException;
	boolean addHoaDonDatPhong(HoaDonDatPhong hddp) throws RemoteException;
